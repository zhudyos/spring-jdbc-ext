...
public class PostgreSQLTest extends AbstractTransactionalTestNGSpringContextTests {
    ...
    static class ContextConfiguration {
        ...
        public DataSource dataSource() {
            ...
            config.setJdbcUrl("jdbc:postgresql://192.168.99.100:5432/");
    ...
    public void testQueryPage() {
        ...
        List<Map<String, Object>> list = template.queryForList("SELECT * FROM test.PERSON", EmptySqlParameterSource.INSTANCE);
